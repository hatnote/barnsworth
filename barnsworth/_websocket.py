...
class WebSocket(object):
    ...
    __slots__ = ('utf8validator', 'utf8validate_last', 'closed',
                 'stream', 'raw_write', 'raw_read', 'connection')
    ...
    def __init__(self, connection):
        ...
        self.raw_write = connection.write
        self.raw_read = connection.read
    ...
    def __del__(self):
        try:
            ...
            pass  # close() may fail if __init__ didn't complete
    ...
    def read_frame(self):
        ...
        header = Header.decode_header(self.raw_read)

        if header.flags:
            raise ProtocolError('unexpected flags: %r' % header.flags)
